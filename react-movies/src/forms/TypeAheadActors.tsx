...
const actors: actorDTO[] = [{
    ...
    const [draggedElement, setDraggedElement] = useState<actorDTO | undefined>(undefined);

    function handleDragStart(actor: actorDTO)
    {
        setDraggedElement(actor);
    }

    function handleDragOver(actor: actorDTO)
    {
        if (!draggedElement)
        {
            return;
...
interface typeAheadActorsProps {
    ...
    onRemove(actor: actorDTO): void;
    listUI(actor: actorDTO): ReactElement;
}